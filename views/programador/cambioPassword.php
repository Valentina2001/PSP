<?php $title = "Programador | Actualizar contraseña"; include_once "views/head.php"; include_once "views/header.php"?>

<section class="section pt-4">
  <form name="formulario" method="POST"  action="<?php echo constant('URL') ?>programador/cambiarPassword"  class=" login__content" enctype="multipart/form-data">
