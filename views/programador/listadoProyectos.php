<?php $title = "Proyectos | Proyetos"; include_once "views/head.php"; include_once "views/header.php"?>
                    ...
                    <tbody>
                      <?php
                        foreach ($this->data as $row) {
                          ...
                          if($row['terminado']){
                            echo "<td class='text-center'><a href='#'><i class='far fa-check-square'></i></a></td>";
                          }else{
                            echo "<td class='text-center'><a href='#'><i class='far fa-square'></i></a></td>";
                          }
