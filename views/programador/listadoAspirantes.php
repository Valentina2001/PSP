<?php $title = "Programadores | Listado Aspirantes"; include_once "views/head.php"; include_once "views/header.php"?>
                        ...
                        <tr>
                            <?php
                                ...
                                for ($i = 0; $i < count($this->data); $i++){
                                    ...
                                    echo "</td><td><a href='".constant('URL')."programador/delAspirante/".$this->data[$i]['cedula']."' class='btn btn-outline-danger fas fa-times'></a> </td> </tr>";
                                }
                            ?>
                        </tr>
                    </tbody>
